        ...
        <div class="container-fluid" id="print_out">
			<table class="table table-hover table-stripped">
				...
				<tbody>
                    ...
                    where ((date(l.date_start) BETWEEN '$date_start'  and '$date_end') OR (date(l.date_end) BETWEEN '$date_start'  and '$date_end')) {$where} {$depart} order by unix_timestamp(l.date_start) asc,unix_timestamp(l.date_end) asc";
						$qry = $conn->query($sql);
