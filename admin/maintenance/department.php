...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=maintenance/manage_department" class="btn btn-sm btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
		</div>
							...
							<td>
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon text-primary" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item" href="?page=maintenance/manage_department&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
	...
	<?php else: ?>
			...
			<!-- <a href="./" ></a> -->
			<!-- <a href="<?php echo base_url ?>admin/?page=404.php"> -->
