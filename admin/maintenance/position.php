...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" class="btn btn-sm btn-primary" id="create_new"><span class="fas fa-plus"></span>  Create New</a>
		</div>
        ...
        <div class="container-fluid">
			<table class="table table-stripped table-hover">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `position_list` order by unix_timestamp(date_updated) desc, unix_timestamp(date_created) desc ");
...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Position Details",'maintenance/manage_position.php?id='+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Create New Position",'maintenance/manage_position.php')
		})
		$('.table').dataTable();
	})
