...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-sm btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td>
								...
								if ($row['type'] == 1) {
									...
									echo 'Leave Application Approver';
								}elseif ($row['type'] == 4) {
									echo 'Credit Leave Creator';
								}elseif ($row['type'] == 5) {
									echo 'Credit Leave Approver';
								}elseif ($row['type'] == 6) {
									echo 'Teaching Records';
								}elseif ($row['type'] == 7) {
									echo 'Non-Teaching Records';	
								}elseif ($row['type'] == 8) {
									echo 'HRM';		
								}elseif ($row['type'] == 9) {
									echo 'Department';	
							...
							<td>
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon text-primary" data-toggle="dropdown">Action<span class="sr-only">Toggle Dropdown</span>
				                  </button>
