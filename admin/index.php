...
<?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <!-- <div class="modal-footer">
        <button type="button" class="btn btn-float btn-primary" id='submit' onclick="$('#uni_modal form').submit()">Save</button>
        <button type="button" class="btn btn-float btn-danger" data-dismiss="modal">Cancel</button>
      </div> -->
      </div>
    </div>
  </div>
