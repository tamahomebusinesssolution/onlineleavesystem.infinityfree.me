    ...
    <form action="" id="update-status-form">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control rounded-0">
                    <option class="text-primary" value="0" <?php echo (isset($status) && $status ==0)?'selected' : '' ?>>Pending</option>
                    <option class="text-success" value="1" <?php echo (isset($status) && $status ==1)?'selected' : '' ?>>Approved</option>
                    <option class="text-danger" value="2" <?php echo (isset($status) && $status ==2)?'selected' : '' ?>>Deny</option>
                    <option class="text-warning" value="3" <?php echo (isset($status) && $status ==3)?'selected' : '' ?>>Cancelled</option>
                </select>
            </div>
    </form>
</div>
