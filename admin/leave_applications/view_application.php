...
<!--             <p class="m-0 p-0">3. DATE OF FILING:</p>
    ...
    <div class="row">
        <div class="col-sm-6 border-top-1 border-left-1 border-bottom-0 border-right-0" style="border: 1px solid #000">         
            ...
            <p class="text-center m-0 p-0"><input disabled=""type="text" class="text-center border-top-0 border-left-0 border-right-0" style="width: 80%; font-weight: bold;" value="<?php echo $_settings->info('hrmo') ?>" ></p>
            <p class="text-center m-0 p-0"><input disabled=""type="text" class="text-center border-0" style="width: 100%;" value="Administrative Officer IV" ></p>
        ...
        <div class="col-sm-6 border-top-1 border-left-1 border-bottom-0 border-right-1" style="border: 1px solid #000">
            ...
            <div class="ml-2 px-1" style="text-align: justify-all;">
                ...
                <p class="text-center m-0 p-0"><input disabled=""type="text" class="text-center border-top-0 border-left-0 border-right-0" style="width: 80%; font-weight: bold;" value="<?php if($designation_id == '6' || $designation_id == '44') { 
                ...
                <p class="text-center m-0 p-0"><input disabled=""type="text" class="text-center border-0" style="width: 100%;" value="<?php if($designation_id == '6'): { 
                        echo "Public Schools District Supervisor";
                    }elseif($designation_id == '44'): {
                        echo "Immediate Superior";
                    }elseif(($department_id == '2') || ($department_id == '3') || ($department_id == '4') || ($department_id == '5')):{
    ...
    <div class="row" style="border: 1px solid #000">
        ...
        <div class="col-sm-12 mt-4" >         
            <p class="text-center m-0 p-0">
                <input disabled=""type="text" class="text-center border-top-0 border-left-0 border-right-0" style="width: 50%; font-weight: bold;" 
            ...
            <p class="text-center m-0 p-0">
                <input disabled=""type="text" class="text-center border-0" style="width: 100%;" value="<?php if($leave_days > 30) { 
