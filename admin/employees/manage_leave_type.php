        ...
        <table class="table">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th class="px-2 py-1">Privilege Leave</th>
                   <!--  <th class="px-2 py-1">Beginning</th> -->
            ...
            <tbody>
                <?php 
                $lt = $conn->query("SELECT * FROM `leave_types` where `status` = '1' order by id asc ");
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" step="any" name="leave_credit[]" value="<?php echo (isset($ltc[$row['id']])) ? $ltc[$row['id']] : $row['default_credit'] ?>" class="form-control rounded-0" hidden>
                    </td>
